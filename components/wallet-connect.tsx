  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-72 sm:w-56">
        ...
        <DropdownMenuItem
          onClick={copyAddress}
          className="flex cursor-pointer items-center justify-between px-3 py-3 sm:py-2 touch-target"
        >
        ...
        <DropdownMenuItem asChild>
          <a
            ...
            className="flex w-full cursor-pointer items-center justify-between px-3 py-3 sm:py-2 touch-target"
          >
        ...
        <DropdownMenuItem
          ...
          className="flex cursor-pointer items-center justify-between px-3 py-3 sm:py-2 text-red-500 focus:text-red-500 touch-target"
        >
