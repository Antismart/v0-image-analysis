...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-transparent bg-primary text-primary-foreground hover:bg-primary/80 dark:hover:bg-primary/70",
        secondary:
        ...
        outline: "text-foreground dark:border-muted/50 dark:text-white/90",
      },
    },
    defaultVariants: {
      variant: "default",
