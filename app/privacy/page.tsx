      ...
      <div className="container mx-auto px-4 py-8">
        <main className="py-12 max-w-3xl">
          ...
          <section className="mb-8">
            ...
            <p>
              Your privacy is important to us. This Privacy Policy explains how Pamoja Events collects, uses, and protects your information.
            </p>
          </section>
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-2">2. Information We Collect</h2>
            <p>
              We may collect information you provide directly, such as your name, email address, and event details. We may also collect usage data to improve our services.
            </p>
          </section>
          <section className="mb-8">
          ...
          <section className="mb-8">
            ...
            <p>
              We do not sell your personal information. We may share data with trusted third parties to operate our platform, comply with legal obligations, or protect our rights.
            </p>
          </section>
          <section className="mb-8">
          ...
          <section>
            ...
            <p>
              For questions about this Privacy Policy, please contact us at support@pamoja.events.
            </p>
          </section>
        </main>
      </div>
